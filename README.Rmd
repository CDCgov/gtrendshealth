...
This packages connects to the Google Trends for Health API to query Google
...
```{r eval=is.character(tryCatch(gtrendshealth::get_gt_api_key(), error = function(e) FALSE)) && !file.exists("man/figures/README-example-1.png")}
#| label: example
